...
export class UserComponent implements OnInit, AfterViewChecked, AfterViewInit, OnDestroy {
  ...
  buildProfileForm() {
    this.userProfile = this.formBuilder.group({
      ...
      qualAcFoundation: [false],
      qualAcCoach: [false],
      qualAcProfessionalCoach: [false],
      qualAcMasterCoach: [false],
      qualApecsAssociate: [false],
      qualApecsProfessional: [false],
      qualApecsMaster: [false],
  ...
  loadUserProfileData(p: CoachProfile) {
    ...
    this.userProfile.patchValue({
      ...
      qualEmccFoundation: p.qualEmccFoundation ? p.qualEmccFoundation : null,
      qualEmccPractitioner: p.qualEmccPractitioner ? p.qualEmccPractitioner : null,
      qualEmccSeniorPractitioner: p.qualEmccSeniorPractitioner ? p.qualEmccSeniorPractitioner : null,
      qualEmccMasterPractitioner: p.qualEmccMasterPractitioner ? p.qualEmccMasterPractitioner : null,
      qualAcFoundation: p.qualAcFoundation ? p.qualAcFoundation : null,
      qualAcCoach: p.qualAcCoach ? p.qualAcCoach : null,
      qualAcProfessionalCoach: p.qualAcProfessionalCoach ? p.qualAcProfessionalCoach : null,
      qualAcMasterCoach: p.qualAcMasterCoach ? p.qualAcMasterCoach : null,
      qualApecsAssociate: p.qualApecsAssociate ? p.qualApecsAssociate : null,
      qualApecsProfessional: p.qualApecsProfessional ? p.qualApecsProfessional : null,
      qualApecsMaster: p.qualApecsMaster ? p.qualApecsMaster : null,
