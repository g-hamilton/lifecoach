...
@Component({
  selector: 'app-service-promo-video-uploader',
  templateUrl: './service-promo-video-uploader.component.html',
  styleUrls: ['./service-promo-video-uploader.component.scss']
})
export class ServicePromoVideoUploaderComponent implements OnInit {
