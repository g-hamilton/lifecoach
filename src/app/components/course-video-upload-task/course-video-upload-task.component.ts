...
export class CourseVideoUploadTaskComponent implements OnInit {
    ...
    this.snapshot = this.task.snapshotChanges().pipe(
      ...
      finalize( async () =>  {
        ...
        courseCopy.lectures[index].video = {
          ...
          duration: this.duration, // video duration captured from hidden HTML video element on file select
