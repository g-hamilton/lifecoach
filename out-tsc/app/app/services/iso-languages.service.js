...
let IsoLanguagesService = class IsoLanguagesService {
    constructor() {
        this.languages = {
            aa: {
                '639-1': 'aa',
...
IsoLanguagesService = __decorate([
    Injectable({
        providedIn: 'root'
    }),
    __metadata("design:paramtypes", [])
], IsoLanguagesService);
export { IsoLanguagesService };
//# sourceMappingURL=iso-languages.service.js.map