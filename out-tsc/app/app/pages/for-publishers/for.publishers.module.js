...
let ForPublishersModule = class ForPublishersModule {
};
ForPublishersModule = __decorate([
    NgModule({
        imports: [
            CommonModule,
...
export { ForPublishersModule };
//# sourceMappingURL=for.publishers.module.js.map