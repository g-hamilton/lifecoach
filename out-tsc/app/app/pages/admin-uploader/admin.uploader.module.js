...
let AdminUploaderModule = class AdminUploaderModule {
};
AdminUploaderModule = __decorate([
    NgModule({
        imports: [CommonModule, RouterModule.forChild(AdminUploaderRoutes), ComponentsModule],
        declarations: [AdminUploaderComponent]
    })
], AdminUploaderModule);
export { AdminUploaderModule };
//# sourceMappingURL=admin.uploader.module.js.map