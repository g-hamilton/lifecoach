...
let PersonHistoryModule = class PersonHistoryModule {
};
PersonHistoryModule = __decorate([
    NgModule({
        imports: [
            CommonModule,
...
export { PersonHistoryModule };
//# sourceMappingURL=person.history.module.js.map